...
In the pictures we've reduced the lengths of the frame vectors for clarity.
	...
	\end{center}
In each case $\textcolor{red}{\ve_1}, \textcolor{blue}{\ve_2}$ were obtained by differentiating with respect to the co-ordinates (and normalizing if necessary). This works because all the co-ordinate systems for all three examples are \emph{orthogonal.}
\end{examples}
